...
const CreateEvent = () => {
  ...
  const handleSubmit = async (values: typeof initialValues) => {
    try {
      ...
      if (images.length > 0) {
        uploadedImages = await Promise.all(images.map((imageFile) => fileToDataUrl(imageFile)));
      ...
      toast({
        title: 'Success!',
        description: response.message || 'Event created successfully. Waiting for admin approval.',
      });
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Host an amazing volunteering opportunity and make a difference
          </p>
        </div>
            ...
            <Form className="space-y-6">
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Add up to 10 images to showcase your event. The first image will be
                  used as the banner.
                </p>
              </FormSection>
